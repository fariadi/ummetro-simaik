...
@section('content')
    ...
    {{-- @dd($sdmRow->id)s --}}
    <a href="{{ route('download.pegawai', $sdmRow->id) }}" class="btn btn-primary mb-1">Download
        Portofolio</a>

    @if (!$pegawai)
        <div class="row">
            <div class="col-md-12 mb-4 mb-md-2">
                <div class="alert alert-warning bg-warning text-white alert-dismissible d-flex align-items-baseline"
                    role="alert">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img src="{{ $profil && isset($profil->foto) ? asset('storage/' . $profil->foto) : asset('assets/img/avatars/0.png') }}"
                    ...
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-tab-home" aria-controls="navs-tab-home" aria-selected="true">Informasi
                                Ranting/Cabang/Daerah</button>
                        </li>
                        <li class="nav-item"><button type="button" class="nav-link" role="tab"
                                ...
                                aria-selected="false">Aktivitas Ranting/Cabang/Daerah</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body mt-4">
                    <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tab-home" role="tabpanel">
                            ...
                            <div class="info-container">
                                <dl class="row mt-2">
                                    ...
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->ranting_tingkat ? strtoupper($pegawai->ranting_tingkat) : 'Tidak ada' }}
                                    </dd>

                                    <dt class="col-sm-3">Provinsi</dt>
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->rantingProv ? $pegawai->rantingProv->nama : '-' }}</dd>

                                    <dt class="col-sm-3">Kabupaten</dt>
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->rantingKab ? $pegawai->rantingKab->nama : '-' }}</dd>

                                    <dt class="col-sm-3">Kecamatan</dt>
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->rantingKec ? $pegawai->rantingKec->nama : '-' }}</dd>

                                    <dt class="col-sm-3">Alamat</dt>
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->ranting_jalan ? $pegawai->ranting_jalan : '-' }}</dd>

                                    <dt class="col-sm-3 text-truncate">Desa/Kelurahan</dt>
                                    <dd class="col-sm-9">
                                        {{ $pegawai && $pegawai->ranting_desa_kel ? $pegawai->ranting_desa_kel : '-' }}
                                    </dd>
                        ...
                        <div class="tab-pane fade" id="navs-tab-profile" role="tabpanel">
                            ...
                            <hr />
                            <a href="javascript:void(0);" class="btn btn-primary on-add-aktivitas-ranting"
                                data-pegawai="{{ $sdmId }}" data-bs-toggle="modal"
                                data-bs-target="#modal-aktvts-ranting-add">Tambah Aktivitas</a>
                            <div class="card  mt-3">
            ...
            <div class="card  mb-3">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-tab-bbq" aria-controls="navs-tab-bbq"
                                aria-selected="true">Pengajuan Baru</button>
                        </li>
                        <li class="nav-item"><button type="button" class="nav-link" role="tab"
                                data-bs-toggle="tab" data-bs-target="#navs-tab-surah" aria-controls="navs-tab-surah"
                                aria-selected="false">Riwayat Hafalan Surah & Ayat</button>
                        </li>
                    </ul>
                </div>
                <div class="card-body mt-4">
